...
<!-- Mirrored from themefileir.com/Colak/ltr/demo4/ by themefileir/3.x [XR&CO'2014], Tue, 11 Jan 2022 20:56:37 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <title>Sales Admin | Colak - Multipurpose Bootstrap Dashboard Template </title>
    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="index-2.html" class="nav-link"> Colak </a>
            </li>
        </ul>
    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a target="_blank" href="#Colak/documentation/index.html" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
    ...
    <div id="content" class="main-content">
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © 2021 <a target="_blank" href="#">themefileir</a>, All rights reserved.</p>
            </div>
...
<!-- Mirrored from themefileir.com/Colak/ltr/demo4/ by themefileir/3.x [XR&CO'2014], Tue, 11 Jan 2022 20:57:44 GMT -->
</html>